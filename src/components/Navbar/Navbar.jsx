...
// import {count} from '../Product/ProductCard'
            ...
            <div className="hidden lg:block">
              <ul className="flex items-center gap-4">
                ...
                <li className="relative cursor-pointer group">
                  <a href="#" className="flex items-center gap[2px] font-semibold hover:text-black text-gray-500 dark:hover:text-white py-2">
                    Quick Links
                  <span>
